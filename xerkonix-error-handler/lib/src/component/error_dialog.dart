import 'package:xerkonix_error_handler/src/error_message_handler/xerkonix_message.dart';
import 'package:flutter/material.dart';

import '../error_message_handler/xerkonix_message_handler.dart';

class XkErrorDialog extends StatelessWidget {
  const XkErrorDialog(
      {super.key,
  ...
  final XkErrorMessage errorMessage;
