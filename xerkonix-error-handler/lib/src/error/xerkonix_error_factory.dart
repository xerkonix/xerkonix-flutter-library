// These constructors keep every argument explicit (not super-parameters) so the
// per-field `?? default` value-defaulting pattern reads uniformly across the
// subtype hierarchy.
...
class UserInputError extends XkErrors {
...
class InvalidFormat extends XkErrors {
...
class UnknownError extends XkErrors {
  UnknownError(
      {String? code,
      String? type,
      String? message,
...
class UnstableNetwork extends XkErrors {
