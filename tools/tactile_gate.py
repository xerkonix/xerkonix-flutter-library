...
v4.5.0 어휘: 무채색 캔버스/잉크, 작은 아쿠아 포인트, 검정 역상 면, 서리 유리 사다리.
v3 의 --x-* 토큰은 선언도 사용도 실패다. 라이트 --glass/.52 읽기 면.
"""
...
EXPECT_VERSION = "v4.5.0"

# ─────────────────────────────────────────────────────────────────────────────
# v4.5.0 기대 테이블 (tokens.css)
# ─────────────────────────────────────────────────────────────────────────────
LIGHT: dict[str, str] = {
    "--canvas": "#F5F5F7", "--ground-hi": "#FFFFFF", "--solid": "#FFFFFF",
    ...
    "--glass-reading-alpha": ".52", "--glass-reading-blur": "32px",
    "--glass-reading-contrast": "1.03", "--glass-reading-saturation": "1.06",
    "--glass-navigation-alpha": ".68", "--glass-navigation-blur": "20px",
    "--glass-navigation-contrast": "1.02", "--glass-navigation-saturation": "1.04",
    "--glass-action-alpha": ".18", "--glass-action-blur": "12px",
    "--glass-action-contrast": "1.03", "--glass-action-saturation": "1.05",
    "--glass": "rgba(255,255,255,.52)", "--glass-strong": "rgba(255,255,255,.52)",
    "--glass-navigation": "rgba(255,255,255,.68)", "--glass-action": "rgba(255,255,255,.18)",
    "--glass-accent": "rgba(177,218,225,.16)",
    "--plane-edge": "rgba(255,255,255,.55)", "--plane-rim": "rgba(255,255,255,.82)",
    "--plane-shadow": "rgba(0,0,0,.06)",
    "--glass-edge": "rgba(255,255,255,.82)", "--glass-edge-2": "rgba(0,0,0,.06)",
    "--glass-shadow": "0 8px 32px rgba(0,0,0,.05)",
    "--ctl-shadow": "0 2px 8px rgba(0,0,0,.06)",
    "--graphic-shadow": "0 10px 28px rgba(0,0,0,.08)",
    "--spec": "rgba(255,255,255,.82)", "--inset-bg": "rgba(118,118,128,.14)",
    "--head-glass": "rgba(255,255,255,.68)",
    "--gloss-rim": "rgba(255,255,255,.55)", "--gloss-low": "rgba(255,255,255,0)",
    "--gloss-contact": "rgba(0,0,0,.06)", "--gloss-sheen": "rgba(255,255,255,.55)",
    ...
    "--fs-display": "48px", "--fs-display-mobile": "30px",
    "--fs-section": "36px", "--fs-section-mobile": "26px",
...
DARK_OVERRIDE: dict[str, str] = {
    ...
    "--glass-rgb": "32,32,32",
    "--glass": "rgba(32,32,32,.52)", "--glass-strong": "rgba(32,32,32,.52)",
    "--glass-navigation": "rgba(32,32,32,.68)", "--glass-action": "rgba(32,32,32,.18)",
    "--glass-accent": "rgba(137,192,205,.16)",
    "--plane-edge": "rgba(255,255,255,.22)", "--plane-rim": "rgba(255,255,255,.42)",
    "--plane-shadow": "rgba(0,0,0,.24)",
    "--glass-edge": "rgba(255,255,255,.42)", "--glass-edge-2": "rgba(255,255,255,.18)",
    "--glass-shadow": "0 8px 32px rgba(0,0,0,.4)",
    "--ctl-shadow": "0 2px 10px rgba(0,0,0,.35)",
    "--graphic-shadow": "0 10px 28px rgba(0,0,0,.4)",
    "--spec": "rgba(255,255,255,.38)", "--inset-bg": "rgba(118,118,128,.28)",
    "--head-glass": "rgba(32,32,32,.68)",
    "--gloss-rim": "rgba(255,255,255,.18)", "--gloss-low": "rgba(255,255,255,0)",
    "--gloss-contact": "rgba(0,0,0,.2)", "--gloss-sheen": "rgba(255,255,255,.16)",
        ...
        if prop == "color":
            ...
            if hit:
                out.append(Finding(
                    ...
                    "글자 아쿠아는 --aqua-deep(라이트 5.52:1) 과 --aqua-ink 만"))
...
CONTRAST_PAIRS = [
    ("--ink", "#111111", "--canvas", "#F5F5F7", 4.5, "라이트 본문"),
    ("--ink-2", "#555555", "--canvas", "#F5F5F7", 4.5, "라이트 보조 텍스트"),
    ("--aqua-deep", "#2E6B79", "--canvas", "#F5F5F7", 4.5, "라이트 글자 아쿠아 / 캔버스"),
...
CONTRAST_RECORD = [
    ...
    ("--ink-3 on --canvas", "#888888", "#F5F5F7", 3.26, "비활성·플레이스홀더 전용 — 읽는 글자 금지"),
    ("--aqua-deep outline on --canvas", "#2E6B79", "#F5F5F7", 5.52, "포커스 링 — 비텍스트 3:1 충족"),
    ("--aqua on --canvas", "#6EB4C4", "#F5F5F7", 2.15, "잔여 토큰 — 포커스 링이 아님"),
...
# 셀프테스트
# ─────────────────────────────────────────────────────────────────────────────
ANCHOR = "--canvas:#F5F5F7;--ink:#111111;"
